...
#line 13 "/home/jcueva1109/Documents/Compi2/Ejercicios-Compi2/Mis_Recursos/Ejemplo5_BisonCPP/expr.y"
...
switch (yytype)
    ...
    /// Build a parser object.
     Parser  (std::unordered_map<std::string, double>& vars_yyarg);
    virtual ~ Parser  ();
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      make_LParenthesis ()
      {
        return symbol_type (token::LParenthesis);
      }
#else
      static
      symbol_type
      ...
      make_LineComment ()
      {
        return symbol_type (token::LineComment);
      }
#else
      static
      symbol_type
      ...
      make_BlockComment ()
      {
        return symbol_type (token::BlockComment);
      }
#else
      static
      symbol_type
